...
class Network(nn.Module):
    def __init__(self, encode_layers, Nkoopman, u_dim):
        ...
        # Build the encoder network using residual blocks.
        layers_list = []
...
def train(env_name, train_steps=20000, all_loss=0, encode_dim=12, layer_depth=5, c_loss=1, 
            gamma=0.99, Ktrain_samples=50000, Ktest_samples=20000, Ksteps=15, seed=42, batch_size=64,
    ...
    # Use the Utility data collection pipeline
    ...
    # layers = get_doubling_layers(in_dim, encode_dim)
